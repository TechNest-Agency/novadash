...
const GithubRepo = () => {
  return (
    <div className="flex items-center justify-center py-8">
      <div className=" w-full bg-purple-100/40 rounded-lg p-4 sm:p-6 flex flex-col md:flex-row items-center text-center md:text-left">
        {/* Image Section */}
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <p className="text-gray-600 text-sm sm:text-base w-full max-w-[90%] sm:max-w-[600px] md:max-w-[700px] mb-6">
            As a developer, there is nothing better than getting GitHub Repo
            access. Get all the latest changes, new features, and bug fixes
            without waiting for the next release on the platform. Raise a join
            request by filling up the repository access form by clicking the
            following button.
          </p>
