    ...
    <div>
      <div className="flex flex-col items-center justify-center bg-purple-100 min-h-screen px-4">
        ...
        <p className="mt-4 text-lg text-gray-600 text-center max-w-2xl mx-auto">
          Over a decade of expertise delivering innovative solutions and
          exceptional results across diverse industries. Our seasoned
          professionals bring deep knowledge and proven methodologies to every
          project.
        </p>
        {/* Animated Image */}
