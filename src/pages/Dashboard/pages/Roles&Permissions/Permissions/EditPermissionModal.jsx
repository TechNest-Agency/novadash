...
const EditPermissionModal = ({ isOpen, onClose }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md relative border border-gray-200">
        ...
        <div className="text-center mb-6">
          <h3 className="text-xl font-medium">Edit Permission</h3>
          <p className="text-base text-gray-500 mt-1">Edit permission as per your requirements.</p>
        </div>
