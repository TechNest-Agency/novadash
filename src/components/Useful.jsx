  ...
  },
  {
    ...
    return (
      ...
      `}</style>
               ...
               <div className="text-center mb-12">
                 <h2 className="text-2xl md:text-3xl font-bold mb-4 w-full mx-auto">
                    ...
                    <p className="text-[#8C8C8C] w-[95%] sm:w-[90%] md:w-[70%] lg:w-[60%] mx-auto">
                        Vuexy VueJS Admin Template provides <span className="text-gray-900">30+ pages.</span> Besides, it also contains all the commonly used pages to develop any applications which will <span className="text-gray-900">ease the developer's guide efforts.</span>
                    </p>
               </div>
            ...
            <div className="h-[0.4px] bg-gray-300 my-4 w-full mb-8"></div>
            <div className="h-[0.4px] bg-gray-300 my-4 w-full mb-0 "></div>
