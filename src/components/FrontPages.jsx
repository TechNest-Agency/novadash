...
const FrontPages = () => {
  ...
  const frontPages = [
  {
    title: "Landing",
    img: LandingPageImg, 
    demoUrl: "https://demo.vuexy.com/vuexy-admin-template/vuejs/demo-1/front-pages/landing"
  },
  {
    title: "Payment",
    img: PaymentPageImg, 
    demoUrl: "https://demo.vuexy.com/vuexy-admin-template/vuejs/demo-1/front-pages/payment"
  },
  {
    title: "Pricing",
    img: PricingPageImg, 
    demoUrl: "https://demo.vuexy.com/vuexy-admin-template/vuejs/demo-1/front-pages/pricing"
  },
  {
    title: "Help Center",
    img: HelpCenterImg, 
    demoUrl: "https://demo.vuexy.com/vuexy-admin-template/vuejs/demo-1/front-pages/help-center"
  },
  {
    title: "Checkout",
    img: CheckoutPageImg, 
    demoUrl: "https://demo.vuexy.com/vuexy-admin-template/vuejs/demo-1/front-pages/checkout"
  },
  {
    title: "Auth Pages",
    img: AuthPagesImg, 
    demoUrl: "https://demo.vuexy.com/vuexy-admin-template/vuejs/demo-1/front-pages/auth"
  }
];
      ...
      `}</style>
                ...
                <div className="text-center mb-12">
                    <h2 className="text-2xl md:text-3xl font-bold mb-4 w-full mx-auto">
                         <span className="text-[#7014F2]">Front Pages</span> that Propel Your Launch
                    </h2>
                    <p className="text-[#8C8C8C] w-[95%] sm:w-[90%] md:w-[70%] lg:w-[60%] mx-auto">
                        Vuexy VueJs Admin template provides <span className="text-gray-900">15+ front pages</span>, including a dedicated <span className="text-gray-900">landing page</span>
                       and other  <span className="text-gray-900"> most commonly used pages,</span> saving you time and effort in launching your app.
                    </p>
                </div>
