      ...
      <div className="mx-auto py-14">
        <div className="text-center mb-12">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 w-full mx-auto">
            Pre-defined <span className="text-[#7014F2]">layout options</span>{" "}
            to suit any taste
          </h2>
          <p className="text-[#8C8C8C] w-[95%] sm:w-[90%] md:w-[70%] lg:w-[60%] mx-auto">
            <span className="text-gray-900">NovaDashboard Admin Template</span>{" "}
            also offers Layout options for building{" "}
